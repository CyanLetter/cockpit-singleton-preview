<singleton-preview>
    ...
    <style>
        ...
        .singleton-preview .preview-panel {
            position: absolute;
            top: 0;
            bottom: 0;
            left: 0;
                    ...
                    <div class="uk-grid uk-grid-match uk-grid-gutter">
                        ...
                        <div class="uk-width-1-1" each="{field,idx in fields}" show="{checkVisibilityRule(field) && (!group || (group == field.group)) }" if="{ hasFieldAccess(field.name) }" no-reorder>
                            ...
                            <div class="uk-panel">
                                ...
                                <div class="uk-margin">
                                    <cp-field type="{field.type || 'text'}" bind="data.{ field.localize && parent.lang ? (field.name+'_'+parent.lang):field.name }" opts="{ field.options || {} }"></cp-field>
                                </div>
    ...
    <script>
        ...
        this.on('mount', function() {
            ...
            this.refs.iframe.addEventListener('load', function() {
                ...
                $this.$idle   = setInterval(_.throttle(function() {
                    ...
                    var hash = JSON.stringify({data:$this.data, lang: $this.lang});
        ...
        updateIframe() {
            ...
            var data = {
                'event': 'cockpit:singleton.preview',
